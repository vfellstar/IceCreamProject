;!function (win) {
  ...
  Xadmin.prototype.del_tab = function (id) {
	...
	/**
	 * [open Open the pop-up layer]
	 * @param  {[type]}  title [Pop-up layer title]
	 * @param  {[type]}  url   [Pop-up layer address]
	 * @param  {[type]}  w     [width]
	 * @param  {[type]}  h     [height]
  ...
  /**
   * [close Close the pop-up layer and the parent window is closed]
   * @return {[type]} [description]
   */
